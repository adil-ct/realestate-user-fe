...
const howItWorksData = [
    {
        ...
        ricon: LIcon5,
        description:
            "Invest Tech vets 1,000's of properties from our partners for every 1 that is offered on platform. Once a property makes it through the team's rigorous standards, the property is placed under contract",
    },
    {
        avatar: User1,
        title: 'Property Listed on invest tech',
        id: 2,
        active: false,
        carousel: true,
        licon: null,
        ...
        link: false,
        description:
            "Invest Tech lists the property for sale to our users. Investors can purchase fractional interest in the property",
    },
    {
        avatar: User1,
        ...
        variant: true,
        description:
            'Once the property is successfully onboarded, investors earn pro rata benefits from the property including rental income, property appreciation, and tax benefits directly to their invest tech dashboard. While a professional property manager takes care of the day-to-day, any major operational decisions are put to a vote',
    },
    // {
    //     avatar: User1,

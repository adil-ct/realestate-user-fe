...
export default styled(Badge)(({ theme, ownerState }) => {
  ...
  const { color, border, size, indicator, /*variant,*/ container, children } = ownerState;
  ...
  // border value
  const borderValue = border ? `${borderWidth[3]} solid ` : "none"; //${white.main}

  // borderRadius value
  const borderRadiusValue = borderRadius.section;

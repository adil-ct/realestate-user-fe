...
const LeftItem = styled(Paper, { name: 'top-section-left-item' })(({ theme }) => ({
...
const RightItem = styled(Paper, { name: 'top-section-right-item' })(({ theme }) => ({
    // backgroundColor: 'transparent',
    ...theme.typography.body2,
    display: 'flex',
    flexDirection: 'column',
...
const LeftBackground = styled(Paper, { name: 'top-section-left-background' })(({ theme }) => ({
    boxShadow: 'none',
...
const RightBackground = styled(Paper, { name: 'top-section-right-background' })(({ theme }) => ({
    boxShadow: 'none',
    background: `url(${Clockwise})`,
    position: 'absolute',
    backgroundRepeat: 'no-repeat',
    ...
    return (
        <Box className={`${classes.root} top-container-lg`}>
            <Grid container spacing={2} className='max-width1400'>
                ...
                <LeftItem>
                        <Typography variant="h4" display="inline" className={classes.header1}>
                            Invest like a {" "}
                            <Typography
                                display="inline"
                        ...
                        <Box mt={2}>
                            <Typography
                                ...
                                display="inline"
                            >
                                Create a second source of income, earn appreciation, and receive tax benefits from expertly vetted rental properties. Start building your real estate portfolio with $100
                            </Typography>
                        </Box>
                        <Box className={classes.dFlex}>
                            <MKButton
                                variant="contained"
                                onClick={() =>
                                    handleCloseNavMenu(REGISTER_LINK)
                                }
                        ...
                        <Box mt={{ xs: '20px', md: '30px', lg: "50px" }} /*style={{display : 'inline-block'}}*/>
                            <Typography
                            ...
                            <img src={Partners} alt="Partners" className={classes.partnersIcon} />
                        </Box>
                    </LeftItem>
                </Grid>
                {/* Right side content */}

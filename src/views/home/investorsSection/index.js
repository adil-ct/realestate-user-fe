...
const InvestorsSection = () => {
  ...
  const dataCards = [
    {
      image: img5,
      title: "Lorem",
      subTitle: "Lorem Lorem ipsum dolor sit amet consectetur, adipisicing elit",
  ...
  return (
    <LayoutContainer>
      <ContainerText>
        <Title>
        Invest Tech Investors <b>& Advisors</b>{" "}
        </Title>
        <Description>
          Our investors were also early backers of companies like Robinhood,
          SpaceX, Tesla, Skype. Here’s what they have to say about Invest Tech.
        </Description>
      </ContainerText>
      <WrapLogos>
        {logos.map((l, i) => (
